...
export class TrainingController {
  ...
  public async savingRelation() {
    ...
    teacherOne.name = 'John Doe';

    const teacherTwo = new Teacher();
    teacherTwo.name = 'Harry Doe';

    subject.teachers = [teacherOne, teacherTwo];
    await this.teacherRepository.save([teacherOne, teacherTwo]);
